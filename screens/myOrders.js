        ...
        >
          ...
          >
            <Title
              style={{
                color: "#0866b0",
                fontSize: this.state.lan == "en" ? 18 : 12,
                  ...
                  >
                    <Text
                      style={{
                        color:
                          this.state.activePage === 1 ? "white" : "#6ea8cd",
                        fontSize: this.state.lan == "en" ? 14 : 11,
                        fontFamily: this.state.lan == "en" ? "Montserrat_semiBold" : "montserrat_arabic_regular",
                      }}
                    >
                      {this.state.lan == "en" ? "Ongoing" : "الجاريه"}
        ...
        >
          ...
          <View>
            ...
            <Text
              style={{
                ...
                color: "#0865b0", fontFamily: this.state.lan == "en" ? "Montserrat_semiBold" : "montserrat_arabic_regular",
          ...
          <TouchableOpacity onPress={() => this.navigationSetup(3)}>
            <View>
              ...
              <Text
                style={{
                  textAlign: "center", fontSize: this.state.lan == "en" ? 12 : 10,
                  color: "#ccc", fontFamily: this.state.lan == "en" ? "Montserrat_semiBold" : "montserrat_arabic_regular",
                }}
              >
                {this.state.lan == "en" ? "My Cart" : "سلة الطلب خاصتي"}
              </Text>
          ...
          <TouchableOpacity onPress={() => this.navigationSetup(4)}>
            <View>
              ...
              <Text
                style={{
                  textAlign: "center", fontSize: this.state.lan == "en" ? 12 : 10, color: "#ccc", fontFamily: this.state.lan == "en" ? "Montserrat_semiBold" : "montserrat_arabic_regular",
                }}
              >
                {this.state.user !== null
                  ? this.state.lan == "en"
