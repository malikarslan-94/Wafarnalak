            ...
            {this.state.isLogin === false ? (
              <TouchableOpacity onPress={this.authenticateUser}>
                ...
                >
                  <Text
                    style={{
                      color: "white", margin: 12, fontSize: this.state.lan == "en" ? 12 : 10, alignSelf: "center", fontFamily: this.state.lan == "en" ? "Montserrat_semiBold" : "montserrat_arabic_regular",
                    }}
                  >
          ...
          >
            ...
            <Text
              style={[
                styles.tabtextStyle,
                {
                  color: this.state.Salon ? theme.brownColor : "#ccc", fontFamily: this.state.lan == "en" ? "Montserrat_semiBold" : "montserrat_arabic_regular", fontSize: this.state.lan == "en" ? 12 : 10,
                },
              ]}
            >
          ...
          >
            ...
            <Text
              style={[
                styles.tabtextStyle,
                {
                  color: this.state.cart ? theme.brownColor : "#ccc", fontFamily: this.state.lan == "en" ? "Montserrat_semiBold" : "montserrat_arabic_regular", fontSize: this.state.lan == "en" ? 12 : 10,
                },
              ]}
            >
          ...
          <TouchableOpacity style={styles.footerItemContainerStyle}>
            ...
            <Text
              style={[
                styles.tabtextStyle,
                {
                  color: this.state.Profile ? theme.brownColor : "#ccc", fontFamily: this.state.lan == "en" ? "Montserrat_semiBold" : "montserrat_arabic_regular", fontSize: this.state.lan == "en" ? 12 : 10,
                },
              ]}
            >
