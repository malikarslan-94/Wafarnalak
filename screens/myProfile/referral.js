...
import { appFontScale, scaleSize } from "../../mixin";
            ...
            {this.state.lan === "en" ? (
              ...
              <Title
                style={{
                  ...
                  color: "#0866b0",
                  fontSize: this.state.lan == "en" ? 18 : 13,
                }}
              >
          ...
          >
            ...
            >
              {this.state.lan === "en" ? (
                ...
                <Text
                  style={{
                    fontFamily: "montserrat_arabic_regular", color: "#0866b0",
            ...
            <View style={{ marginTop: 30, paddingHorizontal: scaleSize(10) }}>
              {this.state.lan === "en" ? (
                <Text
                  style={{
                    textAlign: "center",
                ...
                >
                  ...
                  order you’ll get 300 points and they’ll get 300{"\n"} points  as well {"\n"}Start Sharing NOW!
                </Text>
              ) : (
                <Text
                  style={{
                ...
                >
                  ...
                  ستربح 300 نقطة، وسيحصلون هم على 300 نقطة
              ...
              <TouchableOpacity onPress={this.onEmailShare}>
                <View style={{ alignItems: "center" }}>
                  ...
                  {this.state.lan === "en" ? (
                    ...
                    <Text
                      style={{
                        fontFamily: "montserrat_arabic_regular", textAlign: "center",
                        marginTop: 3,
                        fontSize: appFontScale(13)
                      }}
                    >
