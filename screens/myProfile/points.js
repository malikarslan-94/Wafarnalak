...
export default class PointsScreen extends React.Component {
  ...
  getUserPoints = (user) => {
    fetch(
      ...
      .then((responseJson) => {
        console.log("points response", responseJson);
  ...
  render() {
    return (
      ...
      <View style={{ flex: 1, }}>
        <CustomHeader
          lan={this.state.lan}
          Title_en={"Wafarnalak Points"}
          Title_ar={"نقاط وفرنا لك"}
        ...
        <View style={{ backgroundColor: "white" }}>
          ...
          >
            <View style={{ marginTop: 110, alignSelf: "center", marginLeft: -18 }}>
              <View
                style={{
            ...
            >
              ...
              >
                ...
                >
                  {this.state.lan == "en"
                    ? "100 points equals SAR 1"
                    : "100 نقطة تساوي 1 ر.س"}
                </Text>
                <Text
                  style={{
                    color: "white",
              ...
              <View style={{ marginLeft: 15, marginBottom: 15, marginTop: 4 }}>
                ...
                >
                  {"\u2022"}
                  {this.state.lan == "en"
                    ? "500 points equals SAR 5"
                    : "500 نقطة تساوي 5 ر.س"}
                </Text>
                <Text
                  style={{ color: "white", fontSize: 10, textAlign: "left" }}
                >
