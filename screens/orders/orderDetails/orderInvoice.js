      ...
      <View style={{ height: Dimensions.get("screen").height / 2.5 }}>
        ...
        <View>
          ...
          >
            <View>
              <View>
                <Text style={{ color: "#0865b0", textAlign: "left", fontFamily: this.state.lan == "en" ? "" : "montserrat_arabic_regular", }}>
                  {this.props.lan == "en" ? "Service Charges:" : "رسوم الخدمة"}
                </Text>
                {this.props.orderDetail !== {} &&
                  this.props.orderDetail.order_details.map(
          ...
          >
            ...
            <Text style={{ color: "#4a4b4c", fontSize: 14 }}>
              SAR {this.props.invoice && this.props.invoice.servicecharges
                ? this.props.invoice.servicecharges
                : 0}
            </Text>
          </View>
        ...
        {this.props?.invoice?.total_discount !== 0 ? <View>
          <View
            style={{
              width: Dimensions.get("screen").width - 30,
              height: 1,
          ...
          >
            <View>
              {this.props.lan === "en" ? (
                <Text style={{ color: "#0865b0" }}>Total Discount:</Text>
              ) : (
                <Text
                  style={{
                    fontFamily: "montserrat_arabic_regular",
            ...
            <Text style={{ color: "#4a4b4c", fontSize: 14 }}>
              SAR {this.props.invoice && this.props.invoice.total_discount}
            </Text>
          </View>
        </View> : <View></View>}
        <View
